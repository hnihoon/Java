...
public class OverloadingTest {
	...
	public static void main(String[] args) {
		...
		String r3 = Arrays.toString(arr1);	//toString 메소드 리턴 타입 String 입니다.
		...
		//인자의 타입의 Object 일때는 모든 클래스 타입이 됩니다.(String, Member,....)
		//Objen 는 자바클래스의 단군할아버지(최상위 부모클래스)
		...
		System.out.println("arr1 배열 평균값 = " + MyMath.arrayAvgValue(arr1));	//55.75
		System.out.println("arr3 배열 평균값 = " + MyMath.arrayAvgValue(arr3));	//8.36
