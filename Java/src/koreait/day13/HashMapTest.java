...
//ArrayList : 순차적(인덱스로 접근)으로 데이터를 관리하는 자료구조입니다.
...
//		HashMap<String, Integer> map = new HashMap<>();
		...
		map.put("돼지국밥", 8000);
		System.out.println(map);	//	Map은 Key(모든 타입)값이 index(정수) 역활을 합니다.
									//  Key값은 유일하다? or 중복가능하다?X
		
		map.remove("불고기" , 10000);				//인자 ㅡ 리턴형식 : object -> 모든 타입
