...
public class StringMathod2 {
	...
	public static void main(String[] args) {
		...
		temp = msg.replace("2021", "1999");		//인자 2개 - 첫번째 찾는 문자열,
		...
		while(true) {
			...
			if(idx == -1) break;
			cnt++;
			temp = temp.substring(idx+find.length()); //치킨은 length 가 2 -> 첫 번째 치킨 뒤부터 문자열 추출.
		}
