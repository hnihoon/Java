...
public class StringMathod1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("소문자 변환 결과 : " + temp); //"hello, java"변환된 문자열을 메모리에 저장 주소값은 temp 저장합니다.
		System.out.println("원본 msg : " + msg);
		...
		System.out.println("gmail 포함왁인 -contains 메소드 : " + msg.contains("gmail"));
		System.out.println("contains 메소드 : " + msg.contains("naver"));
		
		//4. 전체 문자열이 동일한지 비교 : 내용 비교.
		msg="momo";
		System.out.println("equals 비교(Momo) : " + msg.contentEquals("Momo"));
		System.out.println("equals 비교(momo) : " + msg.contentEquals("momo"));
		System.out.println("equals 비교(momo ) : " + msg.contentEquals("momo "));
