...
public class TryCatchTest2 {
	...
	public static void main(String[] args) {
		...
		while(run) { //while(true) {
			try {
				...
				System.out.println("주문을 완료했습니다. 당신이 주문 음식은 " + menu[sel-1] +  "입니다.");
				run=false;	//break;
	...
	} //반복문으로 catch 에 결렸을 때 다시 입력받는 코딩을 해보세요.
	
//try ~ catch 활용 : 예 파일열기를 할 때 없는 파일을 지정한다면 오류 발생. 자바 클래스들은 꼭 try ~ catch 를 하도록 합니다.
}
