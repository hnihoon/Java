...
public class CharacterTest {	//언어별로 사용하는 문자는 컴퓨터가 처리하기위해 문자 인코딩 코드가 있습니다.
								//가장 많이 사용하는 문자코드 : utf-8 , 영문자/숫자/기호 : ASCII 코드와 같습니다.
	public static void main(String[] args) {
		
		char ch1 = 'a'; //리터럴은 작은 따옴표 사용
		char ch2 = 97;	//char 형식은 정수ㅏㄱㅄ으로는 0 ~ 65535 까지 저장할 수 있습니다.(2바이트)
	
		//예를 들면 한글은 AC00 ~ D7A3
		char ch3 = '\uac00';	//16진수 표기, 유니코드 :\\u 이고 ac00은 16진수 값 1자리 4비트
